...
public class WebIdeProperties extends GenericEmbeddedWebappsProperties {
	...
	final public static String KEY_WEBIDE_PREFIX = "spring.cloud.devops.components.webjars.webide";
	final public static String URI_WEBIDE_BASE = "/webide";
	final public static String PATH_WEBIDE_WEBAPPS = "classpath*:/webide-webapps";
